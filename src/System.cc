...
void System::SaveTrajectoryTUM(const string &filename)
{
	...
	// printf("dump frame with timestamp = %.9lf\n", *lT);
    ...
    f.close();
    cout << endl << "trajectory saved! with Pose num = "<<num <<" blNum = "<<blNum<<" mpTracker->mlRelativeFramePoses.size() = "<<mpTracker->mlRelativeFramePoses.size()<< endl;
}
