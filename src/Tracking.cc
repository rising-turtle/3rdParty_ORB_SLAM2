...
bool Tracking::TrackReferenceKeyFrame()
{
    ...
    // If enough matches are found we setup a PnP solver
     ORBmatcher matcher(0.8, true); // ORBmatcher matcher(0.7,true);
    ...
    if(nmatches<15) // 15
    {
    	cout <<"TrackReferneceKeyFrame() Failed: nmatches = "<<nmatches<<endl;
     	return false;
    }
   ...
   if(nmatchesMap < 10) // 10
   {
	cout <<"TrackReferenceKeyFrame() Failed: nmatchesMap = "<<nmatchesMap<<endl; 
   }
    return nmatchesMap>=10; // 10
}
...
bool Tracking::TrackWithMotionModel()
{
    ...
    if(nmatches<20) //  20 
    {
    	cout<<"nmatches = "<<nmatches<<" failed tracking!"<<endl;
    	return false;
    }
    ...
    // cout <<"in TrackWithMotionModel nmatchesMap = "<<nmatchesMap<<endl;
    if(nmatchesMap < 10) // 10
   {
	cout <<"TrackWithMotionModel() Failed: nmatchesMap = "<<nmatchesMap<<endl; 
   }
    return nmatchesMap>=10; // 10
}
...
bool Tracking::NeedNewKeyFrame()
{
    ...
    // cout <<"mThDepth = "<<mThDepth<<" nMap = "<<nMap<<" nTotal = "<<nTotal<<" ratioMap = "<<ratioMap<<endl;

    // Thresholds
    float thRefRatio = 0.65f; // 0.75
    if(nKFs<2)
        thRefRatio = 0.4f;
    ...
    // cout << "mCurrentFrame.mnId = "<<mCurrentFrame.mnId<<" mnLastKeyFrameId = "<<mnLastKeyFrameId<<" mMaxFrames = "<<mMaxFrames<<endl;
    // cout << "mCurrentFrame.mnId = "<<mCurrentFrame.mnId<<" mnLastKeyFrameId = "<<mnLastKeyFrameId<<" mMinFrames = "<<mMinFrames<<" bLocalMappingIdle = "<<(bLocalMappingIdle?"yes":"no")<<endl;
    // cout <<"mnMatchesInliers = "<<mnMatchesInliers<<" nRefMatches = "<<nRefMatches<<" thRefRatio = "<<thRefRatio<<" ratioMap = "<<ratioMap<< " thMapRatio = "<<thMapRatio<<endl;
